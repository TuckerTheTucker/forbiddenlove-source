...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-kyle':
				frames = Paths.getSparrowAtlas('characters/kyle');
	
				animation.addByPrefix('idle', 'kyle idle', 24, false);
				animation.addByPrefix('singUP', 'kyle note up', 24, false);
				animation.addByPrefix('singLEFT', 'kyle note left', 24, false);
				animation.addByPrefix('singRIGHT', 'kyle note right', 24, false);
				animation.addByPrefix('singDOWN', 'kyle note down', 24, false);
				animation.addByPrefix('singUPmiss', 'kyle miss up', 24, false);
				animation.addByPrefix('singLEFTmiss', 'kyle miss left', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'kyle miss right', 24, false);
				animation.addByPrefix('singDOWNmiss', 'kyle miss down', 24, false);
			...
			case 'eric':
				frames = Paths.getSparrowAtlas('characters/eric');
	
				animation.addByPrefix('idle', 'eric idle', 24, false);
				animation.addByPrefix('singUP', 'eric up', 24, false);
				animation.addByPrefix('singLEFT', 'eric left', 24, false);
				animation.addByPrefix('singRIGHT', 'eric right', 24, false);
				animation.addByPrefix('singDOWN', 'eric down', 24, false);
