...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var camLerp = Main.framerateAdjust(0.05);
		...
		versionShit.setFormat(font, 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
	...
	{		
		...
		if (FlxG.keys.justPressed.FIVE)
			Main.switchState(this, new OffsetState('eric', false));
		#end
		...
		if ((controls.ACCEPT) && (!selectedSomethin))
		{
			...
			FlxFlicker.flicker(magenta, 0.6, 0.1, false);
