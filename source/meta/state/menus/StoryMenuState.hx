...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var yellowBG:FlxSprite = new FlxSprite(0, 56).loadGraphic(Paths.image('menus/base/storymenu/schoolbanner'));
		...
		sprDifficulty.animation.play('weak');
		changeDifficulty();
